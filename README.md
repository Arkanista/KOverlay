...
3. Or download and install the pre-compiled package directly: `sudo pacman -U https://github.com/Arkanista/koverlay/releases/download/v0.1.1/koverlay-0.1.1-1-any.pkg.tar.zst`
