...
3. Or download and install the pre-compiled package directly via terminal: 
   `sudo pacman -U https://github.com/Arkanista/koverlay/releases/download/v0.1.5/koverlay-0.1.5-1-any.pkg.tar.zst`
4. **[Direct Download Link]** You can also download the package manually through your browser: 
   👉 **[Download KOverlay v0.1.5 (.pkg.tar.zst)](https://github.com/Arkanista/koverlay/releases/download/v0.1.5/koverlay-0.1.5-1-any.pkg.tar.zst)**
